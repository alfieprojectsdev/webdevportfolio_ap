...
├── docs/
│   ├── AlfiePelicano_CV_2026.pdf   # Built output (generated by cv/Makefile)
...
The `cv/` directory contains a LaTeX-based CV that compiles to `docs/AlfiePelicano_CV_2026.pdf`.
